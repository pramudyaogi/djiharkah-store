    ...
    <div className="min-h-[80vh] flex items-center justify-center bg-[#fafafa] py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-md w-full bg-white p-10 rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.03)] border border-gray-100 relative z-10">
        <div className="text-center mb-10">
          <h2 className="text-3xl font-playfair font-bold text-zinc-900 mb-3 tracking-tight">Buat Akun Baru</h2>
          <p className="text-gray-500 text-sm">Bergabunglah dengan Djiharkah Store</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            <label className="block text-xs font-semibold text-zinc-600 uppercase tracking-wider mb-2 ml-1">Nama Lengkap</label>
            <input
              type="text"
              required
        ...
        <div className="mt-10 text-center text-sm text-gray-500">
          Sudah punya akun?{' '}
          <Link to="/login" className="font-bold text-zinc-900 hover:text-yellow-600 transition-colors">
            Masuk di sini
          </Link>
        </div>
      </div>
